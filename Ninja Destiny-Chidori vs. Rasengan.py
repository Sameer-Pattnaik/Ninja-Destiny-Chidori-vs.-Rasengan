...
walkRight = [pygame.image.load('photos\\NR2.png'),pygame.image.load('photos\\NR3.png'),pygame.image.load('photos\\NR1.png')]
walkLeft = [pygame.image.load('photos\\NL2.png'),pygame.image.load('photos\\NL3.png'),pygame.image.load('photos\\NL1.png')]

bg = pygame.image.load('photos\\bg.png')
stan = pygame.image.load('photos\\Nstanding.png')

Nh = pygame.image.load('photos\\Nh.png')
Sh = pygame.image.load('photos\\Sh.png')


hitSound = pygame.mixer.Sound("photos\\hit.wav")
bgm = pygame.mixer.music.load("photos\\death_note.mp3")
	...
	def draw(self,win):
		...
		if self.health >0:
			...
			if not(self.standing):
				...
				if self.right:
					win.blit(pygame.image.load('photos\\NR1.png'), (self.x, self.y))
				else:
					win.blit(pygame.image.load('photos\\NL1.png'), (self.x, self.y))
			...
			win.blit(pygame.image.load('photos\\Nd.png'),(self.x,self.y))	
...
class weapons():
	...
	def draw(self,win):
		win.blit(pygame.image.load('photos\\shur.png'),(self.x,self.y))
...
class enemy():
	...
	walkRightS = [pygame.image.load('photos\\SR2.png'),pygame.image.load('photos\\SR3.png'),pygame.image.load('photos\\SR1.png')]
	walkLeftS = [pygame.image.load('photos\\SL2.png'),pygame.image.load('photos\\SL3.png'),pygame.image.load('photos\\SL1.png')]
	...
	def draw(self, win):
		...
		if self.health >0:
			...
			win.blit(text,(180,200))
			win.blit(pygame.image.load('photos\\Sd.png'),(self.x,self.y))
		#pygame.draw.rect(win, (255,0,0),self.hitbox,2)
